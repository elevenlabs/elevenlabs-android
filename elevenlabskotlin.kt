...
/**
 * Main class for ElevenLabs Android SDK
 */
class ElevenLabsSDK private constructor() {
    companion object {
        const val VERSION = "1.1.3"
        
        private const val DEFAULT_API_ORIGIN = "wss://api.elevenlabs.io"
        private const val DEFAULT_API_PATHNAME = "/v1/convai/conversation?agent_id="
        private const val INPUT_SAMPLE_RATE = 16000
        private const val SAMPLE_RATE = 16000
        private const val VOLUME_UPDATE_INTERVAL = 100L
        private const val FADE_OUT_DURATION = 2000L
        private const val BUFFER_SIZE = 1024
        
        // WebSocket message size limits
        private const val MAX_WEBSOCKET_MESSAGE_SIZE = 1024 * 1024 // 1MB
        private const val SAFE_MESSAGE_SIZE = 750 * 1024 // 750KB
        private const val MAX_REQUESTED_MESSAGE_SIZE = 8 * 1024 * 1024 // 8MB
        ...
        /**
         * Configure audio session for the SDK
         */
        fun configureAudioSession(context: Context) {
            ...
            // Enable speaker phone for better audio experience
